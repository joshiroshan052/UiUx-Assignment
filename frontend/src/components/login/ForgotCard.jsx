...
export const ForgotCard = () => {
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', width: 'fit-content', justifyContent: 'center', height: '90vh' }}>
            <div className="forgot-box border">
                ...
                <Link to="/" className="separate" style={{ width: '100%', backgroundColor: 'rgb(246 246 246)', height: '45px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>

...
export default function Card({ img, likes, caption, time, comments, userId, id, saved, filterPosts, filterUserPosts }) {
    ...
    return (
        <div style={{ position: 'relative' }}>
            <div className="card" onClick={() => setEmojiPicker(false)} style={{display:"flex",justifyContent:"normal"}}>
                ...
                <div style={{width:"40%", display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
                  ...
                  <div className="user-details" style={{ marginBottom: '2px', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <div className="left-details" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginLeft: '12px' }}>
                        ...
                        <div className="username" style={{display: 'flex', flexDirection: 'column', marginTop: '-8px' }}>
                            <Link to={user?.username} style={{ fontWeight: 'bold', fontSize: '13.15px', marginLeft: '9px',marginTop:'8px' }}>{user?.username}</Link>
                            
                <div className="timestamp" style={{ marginTop: '3px' }}><p style={{ fontSize: '12.89px', marginLeft: '9px', color: 'gray' }}><ReactTimeAgo date={Date.parse(time)} locale="en-US" /></p></div>
                        </div>
                    </div>
                ...
                <div className="caption" style={{ display: 'flex', flexDirection: 'row', alignItems: "center", marginTop: '8px' }}>
                    ...
                    <p style={{ fontSize: '13.19px', marginLeft: '16px' }}>{captionShow && captionShow}</p></div>
                {
                ...
                <div className="labels" style={{ marginTop: '9px', marginLeft: '9.2px', display: 'flex', flexDirection: 'row', alignItems: 'center' ,backgroundColor:"gray",padding:"2px",borderRadius:"5px"}} >

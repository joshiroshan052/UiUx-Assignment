...
export default function Right() {
    ...
    return (
        <div style={{ backgroundColor:"#D9D9D9", padding:"10px",borderRadius:"10px" }}>
            <div className="my-acc" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div className="switch">
                    <p style={{ color: '#BD00FF', fontSize: '14.55px' }}>Switch</p>
                </div>
            </div>
            <div className="suggestions" style={{ marginTop: '28px' }}>
                <div className="header-suggest" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button onClick={() => handleClickOpen()} className='no-style'><p style={{ color: 'black', fontSize: '14.05px', fontWeight:'bold' }}>See All</p></button>
                    <Dialog
                        PaperProps={{
                            style: {
                                minHeight: '15%',

        ...
        <>
            <div className='' style={{ width: '100%', backgroundColor: 'white', border: '1px solid #dbdbdb', display: 'flex', flexDirection: 'row', minHeight: '90vh', marginBottom: '3vh' }}>
                <div className="left-sett" style={{ width: '230px', height: '100%', marginLeft: '0px', marginTop: '17px' }}>
                    ...
                    <Link to="/accounts/reset" style={params.params !== "reset" ? activeStyle : inactiveStyle}>Change Password</Link>
                    <Link to="/FAQ" style={params.params !== "faq" ? activeStyle : inactiveStyle}>FAQ</Link>
                </div>
                {
                    params?.params === "edit" ?
